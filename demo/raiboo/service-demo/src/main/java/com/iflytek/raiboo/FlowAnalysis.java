...
public class FlowAnalysis {
    ...
    public static class FlowResult implements Cloneable,Comparable<FlowResult> {
        ...
        public String toString() {
            return " market id:" + marketID +
                    ...
                    ", test flow:" + testFlow +
                    ", timestamp[" + timestamp + "]:" + FlowAnalysis.stampToDate(timestamp>1480629600000l?timestamp/1000:timestamp);
        }
    ...
    private Long getTodayStart() throws ParseException {
...
//        System.out.println(start);System.out.println(calendar);
        return dateToStamp(start.toString());
    }

    private Long getTodayEnd() throws ParseException {
        Calendar calendar = Calendar.getInstance();
    ...
    private void init() {
        ...
        msgSql = "select " +
                ...
                "  FROM  raiboo_promotion_message_data" +
...
//        Collections.sort(result);
    ...
    private List<FlowResult> getAnalysisByDay(List<FlowResult> flowResultList) throws CloneNotSupportedException, SQLException, ParseException {
        Calendar calendar = Calendar.getInstance();
        Map<String, FlowResult> ret = new HashMap<String, FlowResult>();
        for(FlowResult r : flowResultList) {
            ...
            r.timestamp /=1000;
            if (ret.containsKey(r.marketID + calendar.getTime().getTime())) {
                ret.get(r.marketID + calendar.getTime().getTime()).add(r);
            } else {
                ret.put(r.marketID + calendar.getTime().getTime() , r.clone());
            }
        }
        List<FlowResult> result = new ArrayList<FlowResult>();
        for (Map.Entry<String, FlowResult> entry : ret.entrySet()) {
...
//        System.out.println(gson.toJson(ret));
    ...
    private List<FlowResult> getDayAnalysisByDay() throws SQLException, ParseException, CloneNotSupportedException {
        ...
        return getAnalysisByDay(flowResultList);
    }
    ...
    public static void main(String[] args) throws SQLException, ParseException, CloneNotSupportedException {
        ...
        flowAnalysis.init();
//        flowAnalysis.getAnalysisByHour(flowAnalysis.getTodayStart(), flowAnalysis.getTodayEnd());
////        System.out.println("==================================");
//        flowAnalysis.getWeekAnalysisByHour();
////        System.out.println("==================================");
//        flowAnalysis.getDayAnalysisByHour();
////        System.out.println("==================================");
//        flowAnalysis.getWeekAnalysisByDay();
////        System.out.println("==================================");
//        flowAnalysis.getMonthAnalysisByDay();
////        flowAnalysis.
//        flowAnalysis.getDayAnalysisByDay();
        System.out.println(flowAnalysis.getRealTimeFlow("week", "hour", "2"));
//        for(int i=0; i<1000; i++) {
//            flowAnalysis.getRealTimeFlow("", "", "");
//        }

//        Map<String, Market> markets = flowAnalysis.getMarketWithID();
//        for(Map.Entry<String, Market> entry : markets.entrySet()) {
//            System.out.println("id:" + entry.getKey());
//            System.out.println("city:" + entry.getValue().city);
//            System.out.println("province:" + entry.getValue().province);
//            System.out.println("province:" + entry.getValue().province);
//            System.out.println("location:" + entry.getValue().location);
//        }
    }
}
