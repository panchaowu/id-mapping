...
public class IdMappingMain3 implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		job.setJobName(IdMappingMain3.class.getName() + ":" + dataname
				+ "-" + starttime);
		job.setMapperClass(IdMappingMR3.IdMappingM3.class);
		job.setReducerClass(IdMappingMR3.IdMappingR3.class);
	...
	public static void main(String[] args) throws Exception {
		...
		int res = ToolRunner.run(new IdMappingMain3(), args);
		System.exit(res);
	}
}
